...
% Active users 
params.active_user_first = 1001;       % The first row of the considered user section (check the scenario description for the user row map)
params.active_user_last = 1010;        % The last row of the considered user section (check the scenario description for the user row map)
...
params.CDL_5G.NRB = 51;             % Number of NR blocks
...
params.OFDM_limit = 612;            % Only the first params.OFDM_limit subcarriers will be considered when constructing the channels
...
% Antenna panel size:
params.CDL_5G.bsAntSize = [8, 8];  % Number of rows and columns in rectangular BS array
% If there are multiple active antennas are available, and different
